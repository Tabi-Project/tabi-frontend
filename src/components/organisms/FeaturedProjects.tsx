...
interface FeaturedProjectsProps {
  projects?: CMSProject[]; // ← optional with default
}
...
export default function FeaturedProjects({
  ...
  return (
    <section className="w-full bg-white">
      ...
      <div className="mx-auto max-w-4xl px-6 sm:px-12 lg:px-16 pb-10 flex flex-col gap-0">
        {visible.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-20 text-center">
            {/* Brand-colored SVG illustration */}
            <svg
              width="160"
              height="140"
              viewBox="0 0 160 140"
            ...
            >
              ...
              {/* Flower petals — 8 fixed positions */}
      ...
      {/* Only show button when there are more than 2 projects */}
      {projects.length > 2 && (
