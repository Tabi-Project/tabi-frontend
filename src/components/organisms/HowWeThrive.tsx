...
const HOW_WE_THRIVE = [
  {
    title: "Open Source",
    desc: "We don't just 'learn'—we ship. Our sisters build real-world tools and contribute to global projects, building a portfolio that speaks louder than a CV.",
    icon: Code2,
    gradient: "from-blue-500 to-cyan-400"
  },
  {
    title: "Direct Mentorship",
    desc: "Skip the guesswork. Get guided by engineering leads and senior tech professionals who have walked the path and are ready to pull you up.",
    icon: Users,
    gradient: "from-purple-500 to-pink-500"
  },
  {
    title: "Safe Space",
    desc: "A radical environment where it is okay to fail, ask 'stupid' questions, and grow at your own pace without judgment.",
    icon: HeartHandshake,
    gradient: "from-brand-primary to-orange-400"
  }
];
  ...
  return (
    <section className="relative py-32 bg-[#fcfcfd] overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-40 pointer-events-none">
        ...
        />
        {/* Abstract floating glassmorphic blurred blobs */}
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between mb-20 gap-6">
          ...
          >
            ...
            <h2 className="mt-3 text-4xl md:text-5xl font-black text-[#1a1a2e] tracking-tight leading-none">
              How We <span className="text-brand-primary italic">Thrive.</span>
            </h2>
          </motion.div>
          ...
          {HOW_WE_THRIVE.map((item, i) => {
            ...
            return (
              ...
              >
                ...
                <div>
                  {/* Icon with animated border glow on hover */}
                  <div className="relative w-14 h-14 mb-8">
                    <div
                      className={`absolute inset-0 bg-linear-to-br ${item.gradient} rounded-2xl blur-md opacity-20 group-hover:opacity-60 transition-opacity duration-500`}
                    />
                ...
                {/* Subtle Interaction Footer inside card */}
