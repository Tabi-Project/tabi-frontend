                  ...
                  >
                    {hasChildren ? (
                      ...
                      >
                        ...
                        />
                        {/* Underline bar: always present, width expands on hover/active */}
                        <span
                          className={`absolute rounded-full bg-brand-primary transition-all duration-300 ${
                    ...
                    {/* Removed old active indicator – now inside each link */}
                    ...
                    {hasChildren ? (
                      <button
                        ...
                        className={`flex items-center justify-between py-3 px-3 rounded-xl text-sm font-medium transition-colors duration-200 w-full text-left ${
                          active
                            ? "bg-[#fdf7ff] text-brand-primary"
                            : "text-[#374151] hover:bg-[#fdf7ff] hover:text-brand-primary"
                        }`}
                      >
                        {t(link.label)}
                        <ChevronDown
