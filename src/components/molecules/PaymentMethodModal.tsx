...
export default function PaymentMethodModal({
  ...
  return (
    ...
    >
      {/* Container Updates: 
          - flex flex-col: allows us to fix the header and scroll the body.
          - overflow-hidden: ensures the rounded corners stay clean.
      */}
      <div className="relative w-full max-w-lg bg-white rounded-[2.5rem] shadow-2xl transition-all duration-300 max-h-[90vh] flex flex-col overflow-hidden">
        {/* Fixed Header */}
        ...
        {/* Scrollable Body:
            ...
            - custom scrollbar classes for better aesthetics.
        */}
        <div
        ...
        >
          {/* Tab Switcher */}
          <div className="flex p-1 bg-brand-surface border border-brand-primary/10 rounded-2xl mb-8 sticky top-0 bg-white/80 backdrop-blur-sm z-10">
            <button
                  ...
                  <div className="flex items-start gap-4 p-4 rounded-2xl bg-orange-50 border border-orange-100/50">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-[13px] leading-relaxed text-gray-700">
                        ...
                        <strong>doesn&apos;t bear your name</strong>, include
                        your <strong>full name</strong> in the payment
                        description.
                      </p>
                    </div>
                  </div>
